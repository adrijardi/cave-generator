...
@js.native
@JSImport("three", JSImport.Default)
object THREE extends js.Object {
  ...
  var ShapeUtils: ShapeUtils                         = js.native
}
...
class CubeCamera(near: Double = js.native, far: Double = js.native, cubeResolution: Double = js.native)
    extends Object3D {
...
class PointLight(color: Double = js.native, intensity: Double = js.native, var distance: Double = js.native)
...
@js.native
@JSImport("three", "PointCloudMaterial")
...
class Spherical(var radius: Double = js.native, var phi: Double = js.native, var theta: Double = js.native)
    extends js.Object {
...
class MorphAnimMesh(geometry: Geometry = js.native, material: MeshBasicMaterial = js.native)
...
class WebGLRenderTarget(var width: Double, var height: Double, options: WebGLRenderTargetOptions = js.native)
...
class WebGLRenderTargetCube(width: Double, height: Double, options: WebGLRenderTargetOptions = js.native)
...
class WebGLProgram(renderer: WebGLRenderer, code: String, material: ShaderMaterial, parameters: WebGLRendererParameters)
    extends js.Object
...
@js.native
@JSImport("three", "ClosedSplineCurve3")
...
class PlaneBufferGeometry extends Geometry {
  def this(width: Double, height: Double, widthSegments: Double = js.native, heightSegments: Double = js.native) =
    this()
  var parameters: js.Any = js.native
}
...
class HemisphereLightHelper(var light: Light, sphereSize: Double, arrowLength: Double, domeSize: Double)
    extends Object3D {
  var colors: js.Array[Color] = js.native
...
@js.native
class ShapeUtils extends js.Object {
  def triangulateShape(contour: js.Array[Vector3], holes: js.Array[Vector3]): js.Array[js.Array[Int]] = js.native
}
...
//  @JSBracketAccess
//  def apply(value: ShapeUtils): String = js.native
//
//  def triangulateShape(contour: js.Array[Vector3], holes: js.Array[Vector3]): js.Array[js.Array[Int]] = js.native
//}
